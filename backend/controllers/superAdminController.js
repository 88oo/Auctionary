...
// a bug here in updateProofStatus, request goes without providing amount and status
...
export const updateProofStatus = catchAsyncErrors(async (req, res, next) => {
  ...
  if (!amount || !status) {
    return next(new ErrorHandler("Please provide amount and status to update."));
  }
